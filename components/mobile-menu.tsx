  ...
  return (
    <>
      ...
      >
        ...
        <nav
          className="grid gap-[18px] px-[30px] pt-[clamp(80px,16vh,120px)]"
          aria-label="Mobile navigation"
        >
          {navigation.map(item => (
            <a
              ...
              className={
                pathname === item.href
                  ? "text-[clamp(3rem,12vw,4rem)] font-light leading-none tracking-[0.04em] uppercase text-gold"
                  : "text-[clamp(3rem,12vw,4rem)] font-light leading-none tracking-[0.04em] uppercase text-warm transition-colors duration-[180ms] hover:text-gold"
              }
            >
              {item.label}
            </a>
